...
ACCENT = "#0369A1"         # main accent (buttons, links, active tab, metric values)
ACCENT_STRONG = "#025481"  # hover / pressed
ACCENT_SOFT = "#3A8DBD"    # lighter partner for gradients and secondary marks
# ---------------------------------------------------------------------------
